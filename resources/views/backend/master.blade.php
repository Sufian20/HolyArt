...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/backend') }}//icon/css/fontawesome-all.min.css">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('AddCategory') }}">Add Ctegory</a></li>
                                <li><a href="{{ route('ViewCategory') }}">View Category</a></li>
                                <li><a href="#">Trash Category</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li><a href="{{ route('ViewService') }}">View Services</a></li>
                                <li><a href="{{route('TrashService')}}">Trash Service</a></li>
                            </ul>
                        </li>
                         <li>
                            <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Coursses </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('AddCoursess') }}">Add Coursses</a></li>
                                <li><a href="{{ route('ViewCoursess') }}">View Coursses</a></li>
                                <li><a href="#">Trash Coursses</a></li>
                            </ul>
                        </li>
                         <li>
                            <a href="javascript: void(0);"><i class="fi-layers"></i> <span> About </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('AddAbout') }}">Add About</a></li>
                                <li><a href="{{ route('ViewAbout') }}">View About</a></li>
                                <li><a href="#">Trash About</a></li>
                            </ul>
                        </li>
                         <li>
                         ...
                         <li>
                            <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Team </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('AddTeam') }}">Add Team</a></li>
                                <li><a href="{{ route('ViewTeam') }}">View Team</a></li>
                                <li><a href="#">Trash Team</a></li>
                            </ul>
                        </li>
                          <li>
                            <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Gallery </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ route('AddPhoto') }}">Add Gallery</a></li>
                                <li><a href="{{ route('AddPhoto') }}">View Gallery</a></li>
                                <li><a href="#">Trash Gallery</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a target="_blank" href="{{ route('ForntPage')}}">
                                <i class="fi-globe"></i> <span> Home </span>
                            </a>
                        </li>
                    </ul>
